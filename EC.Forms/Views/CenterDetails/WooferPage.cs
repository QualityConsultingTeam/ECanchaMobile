...
{
    public class CustomCarrousel: CarouselPage
    {
       public CustomCarrousel()
        {
            
            Children.Add(new WooferPage());
            Children.Add(new WooferPage2());
        }
    }
    ...
    public class WooferPage2 : ContentPage
    {
        public WooferPage2()
        {
            BackgroundColor = Color.White;
