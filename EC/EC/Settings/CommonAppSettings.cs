...
namespace EC.Client.Core.Settings
{
    ...
    {
        private readonly static string _MobileServiceUrl = "http://enlacancha-api.azurewebsites.net/";// "http://YOUR_SITE.azure-mobile.net/";
        private readonly static string _MobileServiceKey = "YOUR_MOBILE_SERVICE_KEY";

        private static readonly string _SignalRUrl = "http://enlacancha-api.azurewebsites.net/";// "http://YOUR_SITE.azurewebsites.net/";
